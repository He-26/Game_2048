...
public class Game_2048 {
    ...
    public Game_2048() {
		...
		restartButton.addActionListener(new ActionListener() {
		    public void actionPerformed(ActionEvent e) {
		        int response = JOptionPane.showConfirmDialog(frame, "Are you sure you want to restart?", "Confirm Restart", JOptionPane.YES_NO_OPTION);
    ...
    public void restartGame() {
        //Restarts the game
    	System.out.println("restartGame executed");
        score = 0;
